...
class PortfolioItem extends BaseActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array(
				'id, title, body, annotation, video, nn, meta_index, meta_title, meta_description, meta_keywords, created_ip, created_datetime, created_user, created_username, modified_ip, modified_datetime, modified_user, modified_username, active',
				'safe',
				'on' => 'search',
			),
		);
    ...
    {
        $order = 'nn DESC, created_datetime DESC';
